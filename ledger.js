const catalog = [
  ...
  ["Perfect Manhattan", "完美曼哈顿", "Whiskey", 128],
  ["Sake Martini", "清酒马天尼", "Signature", 128],
  ["Lemon Cake", "柠檬蛋糕", "Signature", 128],
  ["Tuxedo #2", "燕尾服", "Gin", 128],
  ["Bannockburn", "班诺克本", "Whiskey", 128],
  ["Yukiguni", "雪国", "Signature", 128],
  ["Baijiu Martini", "白酒马天尼", "Signature", 128],
  ["Americano", "美国佬", "Other", 58],
  ["Aviation", "飞行", "Gin", 98],
  ["Bee’s Knees", "蜂膝", "Gin", 78],
  ["Black Russian", "黑俄罗斯", "Vodka", 78],
  ["Bloody Mary", "血腥玛丽", "Vodka", 78],
  ["Blood and Sand", "血与沙", "Whiskey", 98],
